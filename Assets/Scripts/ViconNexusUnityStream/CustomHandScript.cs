                    ...
                    else
                    {
                        ...
                        if (setPosition)
                        {
                            if (fingerId == finger_1)
                            {
                                ...
                                {
                                    case "R1D1":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.ThumbNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Proximal"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.ThumbTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Proximal"]);
                                        break;
                                    case "R1D2":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.ThumbNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Intermediate"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.ThumbTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Intermediate"]);
                                        break;
                                    case "R1D3":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.ThumbTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Distal"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.ThumbTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Distal"]);
                                        break;
                                    case "R1D4":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.ThumbTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Tip"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.ThumbTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Tip"]);
                                        break;
                                    default:
                            ...
                            else if (fingerId == finger_3)
                            {
                                ...
                                {
                                    case "R3D1":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.MiddleNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Proximal"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.MiddleTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Proximal"]);
                                        break;
                                    case "R3D2":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.MiddleNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Intermediate"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.MiddleTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Intermediate"]);
                                        break;
                                    case "R3D3":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.MiddleNormalOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Distal"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.MiddleTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Distal"]);
                                        break;
                                    case "R3D4":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.MiddleNormalOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Tip"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.MiddleTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Tip"]);
                                        break;
                                    default:
                            ...
                            else if (fingerId == finger_4)
                            {
                                ...
                                {
                                    case "R4D1":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.RingNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Proximal"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.RingTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Proximal"]);
                                        break;
                                    case "R4D2":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.RingNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Intermediate"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.RingTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Intermediate"]);
                                        break;
                                    case "R4D3":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.RingNormalOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Distal"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.RingTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Distal"]);
                                        break;
                                    case "R4D4":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.RingNormalOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Tip"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.RingTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Tip"]);
                                        break;
                                    default:
                            ...
                            else if (fingerId == finger_5)
                            {
                                ...
                                {
                                    case "R5D1":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.LittleNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Proximal"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.LittleTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Proximal"]);
                                        break;
                                    case "R5D2":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.LittleNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Proximal"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.LittleTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Proximal"]);
                                        break;
                                    case "R5D3":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.LittleNormalOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Proximal"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.LittleTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Proximal"]);
                                        break;
                                    case "R5D4":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.LittleNormalOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Proximal"]);
                            ...
                            else
                            {
                                ...
                                {
                                    case "R2D1":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.IndexNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Proximal"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.IndexTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Proximal"]);
                                        Debug.Log($"Applying Proximal offset by {(handProperties.BaseNormalOffset * (1 + handProperties.IndexNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Proximal"])}");
                                        break;
                                    case "R2D2":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.IndexNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Intermediate"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.IndexTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Intermediate"]);
                                        Debug.Log($"Applying Intermediate offset by {(handProperties.BaseNormalOffset * (1 + handProperties.IndexNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Intermediate"])}");

                                        break;
                                    case "R2D3":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.IndexNormalOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Distal"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.IndexTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Distal"]);
                                        Debug.Log($"Applying Distal offset by {(handProperties.BaseNormalOffset * (1 + handProperties.IndexNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Distal"])}");
                                        break;
                                    case "R2D4":
                                        Bone.position += Bone.forward * (handProperties.BaseNormalOffset * (1 + handProperties.IndexNormalOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Tip"]);
                                        Bone.position += Bone.right * (handProperties.BaseTangentialOffset * (1 + handProperties.IndexTangentialOffset * 0.01f) * handProperties.JointTangetialOffsetRatios["Tip"]);
                                        Debug.Log($"Applying Tip offset by {(handProperties.BaseNormalOffset * (1 + handProperties.IndexNormalOffset * 0.01f) * handProperties.JointNormalOffsetRatios["Tip"])}");
                                        break;
                                    default:
